...
import {
  ...
  AlertCircle, ArrowRight, LayoutDashboard, Clock
} from 'lucide-react';
...
const SubmitComplaint = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post('/complaints/submit', data, {
        headers: {
        ...
        >
          ...
          <div style={{ display: 'grid', gap: '1rem' }}>
            <button
              ...
              style={{ padding: '1.1rem', fontSize: '1.1rem', borderRadius: '15px' }}
            >
    ...
    <div className="animate-up" style={{ minHeight: '100vh', background: '#f1f5f9' }}>
      <div className="container" style={{ padding: '5rem 2rem', maxWidth: '1100px' }}>
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                color: lang === 'hi' ? 'white' : 'var(--text-main)',
                padding: '0.5rem 1rem',
                borderRadius: '50px',
                fontWeight: '700',
                cursor: 'pointer',
            ...
            <button
              ...
              style={{
                border: 'none',
                background: lang === 'pa' ? 'var(--accent)' : 'transparent',
                color: lang === 'pa' ? 'white' : 'var(--text-main)',
                padding: '0.5rem 1rem',
                borderRadius: '50px',
                fontWeight: '700',
                cursor: 'pointer',
        ...
        >
          <div
            className="glass-panel"
            style={{ padding: '4rem', borderRadius: '30px', background: 'white' }}
          >
            ...
            <form onSubmit={handleSubmit} style={{ display: 'grid', gap: '2rem' }}>
              ...
              <div className="input-group" style={{ marginBottom: 0 }}>
                ...
                >
                  ...
                  />
                  <div className="animate-float" style={{ color: 'var(--accent)', marginBottom: '1rem' }}>
                    <Upload size={48} />
                  </div>
                  <h4 style={{ fontSize: '1.1rem', fontWeight: '800', marginBottom: '0.5rem' }}>
                    {formData.image ? formData.image.name : t.placeholderFile}
                  </h4>
              ...
              >
                {loading ? (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                    <Loader className="animate-spin" size={20} /> {t.btnSubmitting}
                  </div>
                ) : (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                    <Send size={24} /> {t.btnSubmit}
                  </div>
                )}
              </button>
            </form>
          ...
          <aside style={{ position: 'sticky', top: '120px' }}>
            ...
            >
              ...
              >
                <ShieldCheck size={24} /> {t.sidebarTitle}
              </h3>
              <p
                style={{
                  fontSize: '0.9rem',
            ...
            >
              <h4 style={{ fontWeight: '800', marginBottom: '1.25rem', color: 'var(--primary)' }}>
                {t.assistance}
              </h4>
              <Link to="/contact" className="btn btn-outline" style={{ width: '100%', fontSize: '0.9rem' }}>
                <MessageSquare size={18} /> {t.helpdesk}
              </Link>
            </div>
          </aside>
        </div>
